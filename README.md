...
- `config/phases.yaml`：阶段改为需求澄清、规则分析、业务表单作业、流程控制、集成需求、IR 交付。
- `experts/*.expert.yaml`：替换为 BA 专家，包括需求澄清、规则管理、业务表单作业、流程控制、集成需求、IR 聚合和 IR 验证。
...
| `business-form-operation` | 业务表单作业专家 | `OPERATIONS` | `business-form-operations.md`, `field-requirements.yaml`, `operation-permissions.md`, `form-data-analysis.md` |
